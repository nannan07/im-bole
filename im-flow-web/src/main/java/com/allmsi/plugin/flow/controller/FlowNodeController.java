...
public class FlowNodeController {
	...
	@ResponseBody
	public Object receiverSelect(String nodeId, String routeId) {
		if (StrUtil.isEmpty(nodeId) || StrUtil.isEmpty(routeId)) {
			return new WarnProtocol();
		}
		return new SuccessProtocol(flowNodeService.receiverSelect(nodeId, routeId));
	}
